...
if command -v yt2mp3 &> /dev/null; then
    echo "✓ yt2mp3 command is available"
else
    echo "✗ yt2mp3 command not found"
    exit 1
fi
echo ""
